...
-- Snacks-dependent buffer keymaps (available after snacks is loaded)
...
-- Stay on first match when using *
map("n", "*", function()
  vim.cmd("normal! *")
